        ...
        <div class="row justify-content-center text-center blur">
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="{{ route('car.update', compact('car')) }}" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        <label for="exampleInputmodel" class="form-label">Eventi a cui ha partecipato
                    ...
                    <div class="mb-3">
                        <img src="{{ Storage::url($car->img) }}" class="img-fluid" alt="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="owner" class="form-control" value="{{ $car->owner }}"
                            id="exampleInputowner" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <img src="{{ Storage::url($car->userimg) }}" class="img-fluid " alt="">
